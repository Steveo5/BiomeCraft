...
public class QuestNodeBreakBlocksRequirement extends QuestNodeRequirement {
    private ItemStack requiredItem;
    private int amount;

    public QuestNodeBreakBlocksRequirement(ItemStack requirement, int amount) {
        super(QuestNodeRequirementType.BREAK_BLOCKS);
    ...
    public QuestRequirementStatus compare(Object compare) {
        ...
        if (totalOfSimiliarItems < this.getAmount()) {
